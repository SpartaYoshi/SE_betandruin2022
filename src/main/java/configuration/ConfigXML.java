...
public class ConfigXML {
	...
	private static final String CONFIGURATION_FILENAME = "v2-JavaFX/resources/config.xml";
	...
	private ConfigXML(){
		...
		try {
			...
			String value = ((Element)config.getElementsByTagName("src/main/java/businessLogic").item(0)).
					getAttribute("local");
			...
			value = ((Element)config.getElementsByTagName("src/main/java/dataAccess").item(0)).
					getAttribute("local");
